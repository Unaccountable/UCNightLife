...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2022 at 11:17 PM
...
INSERT INTO `comments` (`cid`, `uid`, `date`, `message`, `locationName`) VALUES
(5, 'Anonymous', '2022-02-23 21:53:37', 'pls do something\r\n', 'Bogarts\r\n'),
(6, 'Anonymous', '2022-02-23 22:18:23', 'This is a test of the emergency alert system this is only a test', 'Bogarts\r\n'),
(7, 'Anonymous', '2022-02-23 22:18:23', 'This is a test of the emergency alert system this is only a test', 'Bogarts\r\n'),
(8, 'Anonymous', '2022-02-23 22:18:23', 'This is a test of the emergency alert system this is only a test', 'Bogarts\r\n'),
(9, 'Anonymous', '2022-02-23 22:18:23', 'This is a test of the emergency alert system this is only a test', 'Bogarts\r\n'),
(10, 'Anonymous', '2022-02-23 22:29:42', 'Bogarts is pretty cool\r\n', 'Bogarts\r\n');
...
CREATE TABLE `locationdata` (
  ...
  `lngDescrip` varchar(2000) NOT NULL,
...
INSERT INTO `locationdata` (`id`, `name`, `addr`, `lat`, `lng`, `tags`, `hours`, `descrip`, `lngDescrip`, `intLinks`, `extLinks`) VALUES
...
(8, 'Bogarts\r\n', '2621 Vine St, Cincinnati, OH 45219', 39, -85, 'music,entertainment,live music,drinks', 'N/A', 'Live music hall that hosts a vast variety of acts and performances					near the University of Cincinnati, across Vine Street from Sudsy Malone\'s Rock \'n Roll Laundry & Bar.\n					The venue opened as a ', 'Bogart\'s is a music venue located in the Corryville neighborhood of Cincinnati, Ohio, 					near the University of Cincinnati, across Vine Street from Sudsy Malone\'s Rock \'n Roll Laundry & Bar. 					The venue opened as a vaudeville theater called the Nordland Plaza Nickelodeon in 1905.', '<a href=\"bogarts.php\">', 'https://www.bogarts.com/'),
